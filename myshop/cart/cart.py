...
class Cart(object):
    ...
    def __iter__(self):
        ...
        # Pobranie obiektów produktów i dodanie ich koszyka na zakupy
    ...
    def __len__(self):
        """
        Obliczanie wszystkich elementów w koszyku.
        """
    ...
    def save(self):
        # Oznaczenie sesji jako zmodyfikowanej, aby upewnić się o jego zapisaniu
